...
Source0  : https://files.pythonhosted.org/packages/6d/74/be92e22dac88b31adc4079134360486117de4bed4ccfa2ff9ddb2d24a570/ConfigArgParse-1.2.1.tar.gz
...
%prep
%setup -q -n ConfigArgParse-1.2.1
cd %{_builddir}/ConfigArgParse-1.2.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1586806305
...
cp %{_builddir}/ConfigArgParse-1.2.1/LICENSE %{buildroot}/usr/share/package-licenses/ConfigArgParse/374d44e6763a847adba3b724246d9c3b0273788a
