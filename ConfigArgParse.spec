...
Version  : 1.1
Release  : 34
URL      : https://files.pythonhosted.org/packages/88/9a/05a375c2e34992c6eb8bda11a545f65116935c30d2d7bef2bb9e606b12eb/ConfigArgParse-1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/88/9a/05a375c2e34992c6eb8bda11a545f65116935c30d2d7bef2bb9e606b12eb/ConfigArgParse-1.1.tar.gz
...
%prep
%setup -q -n ConfigArgParse-1.1
cd %{_builddir}/ConfigArgParse-1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1584294781
...
cp %{_builddir}/ConfigArgParse-1.1/LICENSE %{buildroot}/usr/share/package-licenses/ConfigArgParse/374d44e6763a847adba3b724246d9c3b0273788a
