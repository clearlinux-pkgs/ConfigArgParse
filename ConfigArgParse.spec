...
Source0  : https://files.pythonhosted.org/packages/66/37/dd9fcb3b19c1dceea450ee994952e311a96dd827bb09ee19169c3427e0d3/ConfigArgParse-1.0.tar.gz
...
%prep
%setup -q -n ConfigArgParse-1.0
cd %{_builddir}/ConfigArgParse-1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578152117
...
cp %{_builddir}/ConfigArgParse-1.0/LICENSE %{buildroot}/usr/share/package-licenses/ConfigArgParse/374d44e6763a847adba3b724246d9c3b0273788a
