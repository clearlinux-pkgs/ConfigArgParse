...
Source0  : https://files.pythonhosted.org/packages/3f/75/ca907906cd6c4c7097a037f7adaee36b3f32a08b66baed51b86d1fcc6398/ConfigArgParse-1.3.tar.gz
...
%prep
%setup -q -n ConfigArgParse-1.3
cd %{_builddir}/ConfigArgParse-1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1613407091
...
cp %{_builddir}/ConfigArgParse-1.3/LICENSE %{buildroot}/usr/share/package-licenses/ConfigArgParse/374d44e6763a847adba3b724246d9c3b0273788a
